...
[ExecuteInEditMode]
public class StaticStars : MonoBehaviour
{
    ...
    private float _side = 20000f;


    void Awake()
    {
        if (gameObject.GetComponents<StaticStars>().Length > 1)
        {
    ...
    void OnEnable()
    {
        ...
        customSkybox.transform.position = Vector3.zero;
