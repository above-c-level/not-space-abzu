/*  SU_TravelWarp C# Script (version: 1.6)
...
{
    public class TravelWarp : MonoBehaviour
    {
        ...
        private SpaceParticles[] _spaceParticles;
        private Vector3 _previousPosition;
        private SpaceSceneCamera _spaceCamera;
        ...
        void Awake()
        {
            ...
            if (GameObject.FindGameObjectWithTag("SpaceScene_Camera") == null)
                ...
                _spaceCamera = GameObject.FindGameObjectWithTag("SpaceScene_Camera").GetComponent<SpaceSceneCamera>();
        ...
        void LateUpdate()
        {
            ...
            if (_spaceCamera == null)
            {
                ...
                _spaceCamera = FindObjectOfType<SpaceSceneCamera>();
                return;
            }
            ...
            if (Warp && warpState == WarpState.NONE)
            {
                ...
                foreach (GameObject _g in FindObjectsOfType<GameObject>())
                {
                    ...
                    if (!_exclude && _g.GetComponent<SpaceParticles>() != null)
                        _exclude = true;
                ...
                _spaceParticles = FindObjectsOfType<SpaceParticles>();
            ...
            if (warpState != WarpState.NONE)
            {
                ...
                if (_deltaPosition.magnitude > 0.1f)
                {
                    ...
                    foreach (SpaceParticles _s in _spaceParticles)
